...
K_stim = false;           % bath potassium stimulation
current_stim = true;    % current stimulus
Options.PIP2 = 'off';    % dynamic regulation of Kir and TRPV4
...
G_kirbar_Mean = 0.4/sqrt(3)*ones(1,tot_cell_number);   % [nS/mM^0.5] inward rectifier constant
G_kirbar_Mean(ArtECsInds(:)) = 0.65/sqrt(3);

G_kirbar_Std = 0.1;
G_kirbar = G_kirbar_Mean + G_kirbar_Std * randn(1,tot_cell_number);
G_kirbar(ArtECsInds(:)) = G_kirbar_Mean(ArtECsInds(:));
