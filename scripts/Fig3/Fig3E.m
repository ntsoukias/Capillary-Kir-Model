...
for i = 1:numel(RgjVals)
    Rgj = RgjVals(i);
    CapillarySegment(ratio, Rgj, probeCell)
end

%% Equations 
function CapillarySegment(ratio, Rgj, probeCell)
%% Simulation time
...
R_gj = Rgj;  % [Gohm]  gap junctional resistance
...
plot(tplot, Vm(:,probeCell),'k','linewidth',2)
